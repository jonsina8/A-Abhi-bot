...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1807927334 6765929934').split()]
...
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'https://arlinks.in')
